...
import pro.sketchware.GradleSettingsActivity;
...
public class ProjectsAdapter extends RecyclerView.Adapter<ProjectsAdapter.ProjectViewHolder> {
	...
	private void showProjectGradleConfigDialog(HashMap<String, Object> projectMap) {
		Intent intent = new Intent(activity, GradleSettingsActivity.class);
		intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		projectsFragment.openProjectSettings.launch(intent);
	}
	...
	private void showProjectOptionsBottomSheet(HashMap<String, Object> projectMap, int position) {
		...
		binding.gradleConfig.setOnClickListener(v -> {
			showProjectGradleConfigDialog(projectMap);
			projectOptionsBSD.dismiss();
		});
