...
public class DesignActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private void saveVersionCodeInformationToProject() {
        ...
        if (projectMetadata != null) {
            projectMetadata.put("sketchware_ver",
                    GB.d(getApplicationContext()));
            lC.b(sc_id,
                    projectMetadata);
        }
    }
    ...
    /**
     * Shows a Snackbar indicating that a problem occurred while compiling. The user can click on "SHOW" to get to
     * {@link CompileLogActivity}.
     *
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        options.add(new GridOptionAdapter.Option("Show Apk signatures",
                ...
                v -> {
                    ApkSignatures apkSignatures = new ApkSignatures(this,
                            q.finalToInstallApkPath);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    updateOptionVisibility(R.id.action_direct_xml_editor,
                            true);
                    if (viewTabAdapter != null) {
    ...
    private View addOptionItem(LinearLayout container, String title, int iconResId, View.OnClickListener listener) {
        View itemView = getLayoutInflater().inflate(R.layout.property_grid_item,
                container,
                false);
    ...
    private void updateBottomMenu() {
        handler.post(() -> {
            ...
            updateOptionVisibility(R.id.action_show_signatures,
                    isDebugApkExists);
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.design_menu,
                menu);
        return true;
    }
    ...
    private void showSaveBeforeQuittingDialog() {
        ...
        dialog.setNeutralButton(Helper.getResString(R.string.common_word_cancel),
                null);
        dialog.show();
    }
    ...
    private void askIfToRestoreOldUnsavedProjectData() {
        ...
        dialog.setNegativeButton(Helper.getResString(R.string.common_word_no),
                (v, which) -> {
                    B = false;
                    v.dismiss();
                });
    ...
    private void showCurrentActivitySrcCode() {
        ...
        new Thread(() -> {
            ...
            var code = new yq(getApplicationContext(),
                    sc_id).getFileSrc(filename,
                    jC.b(sc_id),
                    jC.a(sc_id),
                    jC.c(sc_id));
            runOnUiThread(() -> {
                ...
                launchActivity(CodeViewerActivity.class,
                        null,
                        new Pair<>("code",
                                code),
                        new Pair<>("sc_id",
    ...
    private void showAvailableJavaFiles() {
        ...
        View customView = a.a.a.wB.a(this,
                R.layout.file_selector_popup_select_java);
    ...
    private void showAvailableViews() {
        Intent intent = new Intent(getApplicationContext(),
                ViewSelectorActivity.class);
        intent.putExtra("sc_id",
                sc_id);
        intent.putExtra("current_xml",
                projectFile.getXmlName());
        intent.putExtra("is_custom_view",
                projectFile.fileType == 1 || projectFile.fileType == 2);
    ...
    void toCollectionManager() {
        launchActivity(ManageCollectionActivity.class,
     ...
     */
    void toAssetManager() {
        launchActivity(ManageAssetsActivity.class,
                null);
    }
    ...
    void toCustomBlocksViewer() {
        new CustomBlocksDialog().show(this,
                sc_id);
    }
     ...
     */
    void toJavaManager() {
        launchActivity(ManageJavaActivity.class,
                null,
                new Pair<>("pkgName",
                        q.packageName));
    }
    ...
    void toPermissionManager() {
        launchActivity(ManagePermissionActivity.class,
                null);
    }
    ...
    void toProguardManager() {
        launchActivity(ManageProguardActivity.class,
                null);
    }
    ...
    void toResourceManager() {
        launchActivity(ManageResourceActivity.class,
    ...
    void toResourceEditor() {
        launchActivity(ResourcesEditorActivity.class,
                openResourcesManager);
    }
     ...
     */
    void toFontManager() {
        launchActivity(ManageFontActivity.class,
                null);
    }
     ...
     */
    void toImageManager() {
        launchActivity(ManageImageActivity.class,
                openImageManager);
    }
     ...
     */
    void toSoundManager() {
        launchActivity(ManageSoundActivity.class,
                null);
    }
    ...
    void toXMLCommandManager() {
        launchActivity(ManageXMLCommandActivity.class,
                null);
    }

    @SafeVarargs
    private void launchActivity(
            Class<? extends Activity> toLaunch, ActivityResultLauncher<Intent> optionalLauncher,
    ...
    private static class BuildTask extends BaseTask implements BuildProgressReceiver {
        ...
        private static void setMargin(MaterialButton view, int leftPx, int topPx, int rightPx, int bottomPx) {
            if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams params = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
                params.setMargins(leftPx,
                        topPx,
                        rightPx,
                        bottomPx);
        ...
        public void onProgress(String progress, int step) {
            ...
            activity.runOnUiThread(() -> {
                ...
                progressBar.setProgress(progressInt,
                        true);
                Log.d("DesignActivity$BuildTask",
                        step + " / " + totalSteps);
            });
        }
    ...
    private static class ProjectSaver extends BaseTask {
        ...
        private void doInBackground() {
            ...
            if (activity != null) {
                ...
                jC.c(sc_id).l();
                activity.runOnUiThread(() -> {
                    bB.a(activity.getApplicationContext(),
