...
//        }
	...
	private List<String> populateAttributes() {
		...
		attrs.add("android:padding");
		attrs.add("android:layout_width");
		attrs.add("android:layout_height");
		attrs.add("android:layout_margin");
		attrs.add("android:layout_marginLeft");
		attrs.add("android:layout_marginTop");
		attrs.add("android:layout_marginRight");
		attrs.add("android:layout_marginBottom");
		attrs.add("android:layout_marginStart");
		attrs.add("android:layout_marginEnd");
		attrs.add("android:layout_gravity");
		attrs.add("android:layout_weight");
		attrs.add("android:alpha");
		attrs.add("android:translationX");
		attrs.add("android:translationY");
		attrs.add("android:scaleX");
		attrs.add("android:scaleY");
		if (bean != null) {
			...
			} else if (classInfo.b("SwipeRefreshLayout")) {
				attrs.add("app:layout_behavior");
			...
			if (classInfo.a("TextView")) {
				...
				attrs.add("android:textSize");
				attrs.add("android:textStyle");
				attrs.add("android:gravity");
				attrs.add("android:lines");
			}
			if (classInfo.b("EditText")) {
				attrs.add("android:hint");
				attrs.add("android:textColorHint");
				attrs.add("android:inputType");
			}
			if (classInfo.b("ImageView")) {
				attrs.add("android:src");
				attrs.add("android:scaleType");
			}
			if (classInfo.b("ProgressBar")) {
				attrs.add("android:progress");
				attrs.add("android:max");
			}
			if (classInfo.b("MaterialButton")) {
				attrs.add("android:icon");
				attrs.add("android:iconGravity");
				attrs.add("android:iconPadding");
				attrs.add("android:iconTint");
				attrs.add("android:iconTintMode");
				attrs.add("android:text");
				// Ripple attributes
				attrs.add("app:rippleColor");
				attrs.add("app:rippleRadius");
				//theme
				attrs.add("app:theme");

				// All these below aren't standard attributes for MaterialButton.
				// android:ripple... attributes are for RippleDrawable, not directly for views in XML.
				// app:rippleColor is the correct one.
				// attrs.add("android:rippleColor");
				// attrs.add("android:rippleColorPressed");
				// attrs.add("android:rippleColorFocused");
				// attrs.add("android:rippleColorHover");
				// attrs.add("android:rippleColorHighlight");
				// attrs.add("android:rippleDuration");
				// attrs.add("android:rippleOverlay");
				// attrs.add("android:rippleOverlayColor");
				// attrs.add("android:rippleOverlayColorPressed");
				// attrs.add("android:rippleOverlayColorFocused");
				// attrs.add("android:rippleOverlayColorHover");
				// attrs.add("android:rippleOverlayColorHighlight");
				// attrs.add("android:rippleOverlayDuration");
				// attrs.add("android:rippleRadius");
				// attrs.add("app:rippleRadiusPressed"); // Not a real attribute
			}
			if (classInfo.b("ImageButton")) {
				attrs.add("android:src");
			}
			if (classInfo.b("ToggleButton")) {
				attrs.add("android:text");
			}
			if (classInfo.b("CheckBox")) {
				attrs.add("android:text");
			}
		}
		// Add more attributes here based on the view type

		// Using streams to remove duplicates while preserving insertion order.
	...
	*/
	private List<String> populateAttributes() {
		...
		// Atributos Padrões (Android)
		attrs.add("android:elevation");
		attrs.add("android:background");
		attrs.add("android:padding");
		attrs.add("android:paddingStart"); // Melhor prática que paddingLeft
		attrs.add("android:paddingEnd");   // Melhor prática que paddingRight
		attrs.add("android:paddingLeft");
		attrs.add("android:paddingTop");
		attrs.add("android:paddingRight");
		attrs.add("android:paddingBottom");
		attrs.add("android:layout_width");
		attrs.add("android:layout_height");
		attrs.add("android:layout_margin");
		attrs.add("android:layout_marginLeft");
		...
		attrs.add("android:scaleX");
		attrs.add("android:scaleY");
		attrs.add("android:id"); // Comumente necessário
		attrs.add("android:visibility"); // Comumente necessário
		attrs.add("android:onClick"); // Para manipuladores de cliques

		if (bean != null) {
			var simpleName = getSimpleName(bean);
			var classInfo = bean.getClassInfo();

			// Material Design: CardView e MaterialCardView
			if (classInfo.b("CardView")) {
				attrs.add("app:cardBackgroundColor");
				attrs.add("app:cardElevation");
				attrs.add("app:cardCornerRadius");
				attrs.add("app:cardUseCompatPadding");
				// Adicionado: Sombra para versões mais antigas
				attrs.add("app:cardMaxElevation");
				attrs.add("app:contentPadding");
				if (simpleName.equals("MaterialCardView")) {
					attrs.add("app:strokeColor");
					attrs.add("app:strokeWidth");
					attrs.add("app:rippleColor"); // Rippple é comum em CardView
				}
			}

			// Layouts Específicos (ConstraintLayout e outros)
			if (classInfo.b("ConstraintLayout") || classInfo.b("ViewGroup")) {
				// Atributos ConstraintLayout (MUITO comuns em apps modernos)
				attrs.add("app:layout_constraintBaseline_toBaselineOf");
				attrs.add("app:layout_constraintBottom_toBottomOf");
				attrs.add("app:layout_constraintEnd_toEndOf");
				attrs.add("app:layout_constraintStart_toStartOf");
				attrs.add("app:layout_constraintTop_toTopOf");
				attrs.add("app:layout_constraintDimensionRatio");
				attrs.add("app:layout_editor_absoluteX");
				attrs.add("app:layout_editor_absoluteY");
				attrs.add("app:layout_constraintWidth_default");
				attrs.add("app:layout_constraintHeight_default");
				attrs.add("app:layout_constraintHorizontal_bias");
				attrs.add("app:layout_constraintVertical_bias");
				attrs.add("app:layout_constraintHorizontal_chainStyle");
				attrs.add("app:layout_constraintVertical_chainStyle");
			} else if (classInfo.b("SwipeRefreshLayout")) {
				// Atributos de comportamento do CoordinatorLayout
				attrs.add("app:layout_behavior");
			} else if (classInfo.b("TabLayout")) {
				attrs.add("app:tabMode");
				attrs.add("app:tabGravity");
				attrs.add("app:tabIndicatorColor"); // Adicionado
				attrs.add("app:tabTextColor"); // Adicionado
			}
			...
			if (classInfo.a("TextView")) {
				...
				attrs.add("android:gravity");
				attrs.add("android:lines");
				attrs.add("android:maxLines"); // Adicionado
				attrs.add("android:minLines"); // Adicionado
				attrs.add("android:ellipsize"); // Adicionado
				attrs.add("android:autoLink"); // Adicionado
				attrs.add("android:singleLine"); // Para compatibilidade
			}
			if (classInfo.b("EditText")) {
				attrs.add("android:hint");
				attrs.add("android:textColorHint");
				attrs.add("android:inputType");
				attrs.add("android:imeOptions"); // Adicionado
				attrs.add("android:maxLines"); // Adicionado
			}
			if (classInfo.b("ImageView")) {
				attrs.add("android:src");
				attrs.add("android:scaleType");
				attrs.add("android:tint"); // Para colorir o Drawable
			}
			if (classInfo.b("ProgressBar")) {
				attrs.add("android:progress");
				attrs.add("android:max");
				attrs.add("android:indeterminateTint"); // Para mudar a cor
				attrs.add("android:minWidth"); // Para tamanho mínimo
			}

			// Material Design: Button e ImageButton
			if (classInfo.b("MaterialButton")) {
				attrs.add("android:icon");
				attrs.add("android:iconGravity");
				attrs.add("android:iconPadding");
				attrs.add("app:iconTint"); // Usa app: para tint
				attrs.add("android:iconTintMode");
				attrs.add("android:text");
				// Ripple attributes
				attrs.add("app:rippleColor");
				...
				//theme
				attrs.add("app:theme");
				// Adicionado: MaterialButton styling
				attrs.add("app:backgroundTint");
				attrs.add("app:cornerRadius");
				attrs.add("app:strokeColor");
				attrs.add("app:strokeWidth");
				attrs.add("app:iconPadding"); // Para consistência
			}
			if (classInfo.b("ImageButton")) {
				attrs.add("android:src");
				attrs.add("android:tint"); // Para colorir o Drawable
			...
			// Outras Views
			if (classInfo.b("ToggleButton") || classInfo.b("CheckBox") || classInfo.b("RadioButton")) {
				attrs.add("android:text");
				attrs.add("android:checked"); // Adicionado: estado de seleção
			}

			// Views de entrada (Material Design)
			if (classInfo.b("TextInputLayout")) {
				attrs.add("app:hintEnabled"); // Adicionado
				attrs.add("app:hintAnimationEnabled"); // Adicionado
				attrs.add("app:boxStrokeColor"); // Adicionado
				attrs.add("app:boxBackgroundColor"); // Adicionado
				attrs.add("app:endIconMode"); // Adicionado
			}

		}

		// Adicione outros atributos genéricos não-padrão comuns aqui.
		// Exemplo: Atributos de Coordenador de Comportamento
		attrs.add("app:layout_anchor");
		attrs.add("app:layout_anchorGravity");

		// Usando streams para remover duplicatas enquanto preserva a ordem de inserção.
		return attrs.stream().distinct().collect(Collectors.toList());
	}
