...
public class NewKeyStoreActivity extends BaseAppCompatActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setTheme(R.style.ThemeOverlay_Material3Expressive_DynamicColors_Dark);
		findViewById(R.id.layout_main_logo).setVisibility(View.GONE);
		Objects.requireNonNull(getSupportActionBar()).setTitle(Helper.getResString(R.string.myprojects_sign_apk_new_certificate_title_new_certificate));
