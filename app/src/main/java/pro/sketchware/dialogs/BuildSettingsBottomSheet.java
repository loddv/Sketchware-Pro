...
public class BuildSettingsBottomSheet extends BottomSheetDialogFragment {
	...
	public static String[] getAvailableJavaVersions() {
		return new String[]{SETTING_JAVA_VERSION_1_7, SETTING_JAVA_VERSION_1_8, SETTING_JAVA_VERSION_1_9, SETTING_JAVA_VERSION_10, SETTING_JAVA_VERSION_11, SETTING_JAVA_VERSION_12};
	}
