...
import static mod.hey.studios.build.BuildSettings.SETTING_JAVA_VERSION_12;
...
public class BuildSettingsBottomSheet extends BottomSheetDialogFragment {
    ...
    private static final int VIEW_ANDROID_JAR_PATH = totalViews++;
    private static final int VIEW_CLASS_PATH = totalViews++;
    private static final int VIEW_PROCESSOR = totalViews++;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = ProjectConfigLayoutBinding.inflate(inflater,
                container,
                false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        setCheckboxValue(binding.cbNoWarnings,
                SETTING_NO_WARNINGS,
                true);
        setCheckboxValue(binding.cbNoHttpLegacy,
                SETTING_NO_HTTP_LEGACY,
                false);
    ...
    private void initializeViews() {
        ...
        binding.rgProcessor.setTag(SETTING_RESOURCE_PROCESSOR);
